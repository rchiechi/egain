NOTE_FREQUENCIES = {'C2': '65.41', 'C#2': '69.30', 'Db2': '69.30', 'D2': '73.42',
                    'D#2': '77.78', 'Eb2': '77.78', 'E2': '82.41', 'F2': '87.31',
                    'F#2': '92.50', 'Gb2': '92.50', 'G2': '98.00', 'G#2': '103.83',
                    'Ab2': '103.83', 'A2': '110.00', 'A#2': '116.54', 'Bb2': '116.54',
                    'B2': '123.47', 'C3': '130.81', 'C#3': '138.59', 'Db3': '138.59',
                    'D3': '146.83', 'D#3': '155.56', 'Eb3': '155.56', 'E3': '164.81',
                    'F3': '174.61', 'F#3': '185.00', 'Gb3': '185.00', 'G3': '196.00',
                    'G#3': '207.65', 'Ab3': '207.65', 'A3': '220.00', 'A#3': '233.08',
                    'Bb3': '233.08', 'B3': '246.94', 'C4': '261.63', 'C#4': '277.18',
                    'Db4': '277.18', 'D4': '293.66', 'D#4': '311.13', 'Eb4': '311.13',
                    'E4': '329.63', 'F4': '349.23', 'F#4': '369.99', 'Gb4': '369.99',
                    'G4': '392.00', 'G#4': '415.30', 'Ab4': '415.30', 'A4': '440.00',
                    'A#4': '466.16', 'Bb4': '466.16', 'B4': '493.88', 'C5': '523.25',
                    'C#5': '554.37', 'Db5': '554.37', 'D5': '587.33', 'D#5': '622.25',
                    'Eb5': '622.25', 'E5': '659.25', 'F5': '698.46', 'F#5': '739.99',
                    ...
                    'B6': '1975.53', 'C7': '2093.00', 'C#7': '2217.46', 'Db7': '2217.46',
                    'D7': '2349.32', 'D#7': '2489.02', 'Eb7': '2489.02', 'E7': '2637.02',
                    'F7': '2793.83', 'F#7': '2959.96', 'Gb7': '2959.96', 'G7': '3135.96',
                    'G#7': '3322.44', 'Ab7': '3322.44', 'A7': '3520.00', 'A#7': '3729.31',
                    'Bb7': '3729.31', 'B7': '3951.07', 'C8': '4186.01', 'C#8': '4434.92',
